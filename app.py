    ...
    if word == "你好":
        ...
        while True:
            ...
            if players_amount == 8:
                ...
                line_bot_api.push_message(WorkSheet_Game.cell(1, 1).value, TextSendMessage(text="第{}天公民投票結束囉~~~".format(DayCount)))
                ...
                if len(Murdereridlist) == 0:
                    message = TextSendMessage(text="本次遊戲為好人方勝利！！！")
                    break
                elif len(Innocentidlist) == 0:
                    message = TextSendMessage(text="本次遊戲為殺手方勝利！！！")
                    break
                else:
        ...
        if match != None:
            ...
            try:
                ...
                if WorkSheet_Game.cell(1, 3).value == "Night":
                    ...
                    elif WorkSheet_Game.cell(player_num, 4).value != "Alive":
